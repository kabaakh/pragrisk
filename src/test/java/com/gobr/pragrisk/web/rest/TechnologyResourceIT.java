...
class TechnologyResourceIT {
    ...
    private static final UUID DEFAULT_PARENT_TECHNOLOGY = UUID.randomUUID();
    private static final UUID UPDATED_PARENT_TECHNOLOGY = UUID.randomUUID();
    ...
    public static Technology createEntity(EntityManager em) {
        Technology technology = new Technology()
            ...
            .parentTechnology(DEFAULT_PARENT_TECHNOLOGY)
    ...
    public static Technology createUpdatedEntity(EntityManager em) {
        Technology technology = new Technology()
            ...
            .parentTechnology(UPDATED_PARENT_TECHNOLOGY)
    ...
    void createTechnology() throws Exception {
        ...
        assertThat(testTechnology.getParentTechnology()).isEqualTo(DEFAULT_PARENT_TECHNOLOGY);
    ...
    void getAllTechnologies() throws Exception {
        ...
        restTechnologyMockMvc
            ...
            .andExpect(jsonPath("$.[*].parentTechnology").value(hasItem(DEFAULT_PARENT_TECHNOLOGY.toString())))
    ...
    void getTechnology() throws Exception {
        ...
        restTechnologyMockMvc
            ...
            .andExpect(jsonPath("$.parentTechnology").value(DEFAULT_PARENT_TECHNOLOGY.toString()))
    ...
    void putNewTechnology() throws Exception {
        ...
        assertThat(testTechnology.getParentTechnology()).isEqualTo(UPDATED_PARENT_TECHNOLOGY);
