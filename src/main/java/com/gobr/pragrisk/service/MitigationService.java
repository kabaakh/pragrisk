...
public class MitigationService {
    ...
    public Optional<Mitigation> partialUpdate(Mitigation mitigation) {
        ...
        return mitigationRepository
            ...
            .map(existingMitigation -> {
                ...
                if (mitigation.getTitle() != null) {
                    existingMitigation.setTitle(mitigation.getTitle());
                }
                if (mitigation.getDescription() != null) {
                    existingMitigation.setDescription(mitigation.getDescription());
                }
                if (mitigation.getFrameworkReference() != null) {
                    existingMitigation.setFrameworkReference(mitigation.getFrameworkReference());
                }
     ...
     */
    @Transactional(readOnly = true)
    public Optional<Mitigation> findOne(Long id) {
