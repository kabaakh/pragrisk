package com.gobr.pragrisk.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.gobr.pragrisk.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.gobr.pragrisk.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.gobr.pragrisk.domain.Actor.class.getName() + ".scenarios");
            ...
            createCache(cm, com.gobr.pragrisk.domain.Vulnerability.class.getName() + ".scenarios");
            ...
            createCache(cm, com.gobr.pragrisk.domain.Technology.class.getName() + ".scenarios");
            ...
            createCache(cm, com.gobr.pragrisk.domain.Environment.class.getName() + ".actors");
