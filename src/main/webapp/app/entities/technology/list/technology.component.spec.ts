...
describe('Technology Management Component', () => {
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.query).toHaveBeenCalledWith(expect.objectContaining({ sort: ['technologyID,desc'] }));
  });
  ...
  it('should calculate the sort attribute for a non-id attribute', () => {
    ...
    // THEN
    expect(service.query).toHaveBeenLastCalledWith(expect.objectContaining({ sort: ['name,desc', 'technologyID'] }));
  });
});
