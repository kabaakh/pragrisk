...
export class TechnologyComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['technologyID', 'name', 'category', 'description', 'techStackType'].includes(this.predicate)) {
      this.predicate = 'technologyID';
      this.ascending = true;
    }
  ...
  protected sort(): string[] {
    ...
    if (this.predicate !== 'technologyID') {
      result.push('technologyID');
    }
    return result;
  }
  ...
  protected onSuccess(data: ITechnology[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
